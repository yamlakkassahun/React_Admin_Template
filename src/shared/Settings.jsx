...
const Settings = () => {
  return (
    <div className="settingSidebar">
          <a href="#" className="settingPanelToggle"> <i className="fa fa-spin fa-cog"></i>
          </a>
            ...
            <div className=" fade show active">
              ...
              <div className="p-15 border-bottom">
                ...
                <div className="selectgroup layout-color w-50">
                  <label className="selectgroup-item">
                    <input type="radio" name="value" value="1" className="selectgroup-input-radio select-layout" />
              ...
              <div className="p-15 border-bottom">
                ...
                <div className="selectgroup selectgroup-pills sidebar-color">
                  ...
                  <label className="selectgroup-item">
                    <input type="radio" name="icon-input" value="2" className="selectgroup-input select-sidebar" />
                    <span className="selectgroup-button selectgroup-button-icon" data-toggle="tooltip"
