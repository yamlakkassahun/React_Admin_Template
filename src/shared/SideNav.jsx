    ...
    <aside id="sidebar-wrapper">
      ...
      <ul className="sidebar-menu">
        ...
        <li className="dropdown active">
          <Link to={"/"} className="nav-link"><i className="bi bi-grid-1x2-fill" style={{ color: 'black'}}></i><span>Dashboard</span></Link>
        </li>
        <li className="dropdown">
          <a href="#" className="menu-toggle nav-link has-dropdown"><i className="bi bi-tv" style={{ color: 'black'}}></i><span>Widgets</span></a>
        ...
        <li className="dropdown">
          <a href="#" className="menu-toggle nav-link has-dropdown"><i className="bi bi-tv" style={{ color: 'black'}}></i><span>Apps</span></a>
          <ul className="dropdown-menu">
        ...
        <li className="dropdown">
          <a href="#" className="menu-toggle nav-link has-dropdown"><i className="bi bi-tv" style={{ color: 'black'}}></i><span>Email</span></a>
          <ul className="dropdown-menu">
        ...
        <li className="dropdown">
          <a href="#" className="menu-toggle nav-link has-dropdown"><i className="bi bi-tv" style={{ color: 'black'}}></i><span>Basic
              Components</span></a>
          <ul className="dropdown-menu">
