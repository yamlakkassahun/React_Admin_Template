    ...
    <nav className="navbar navbar-expand-lg main-navbar sticky">
        <div className="form-inline mr-auto">
          <ul className="navbar-nav mr-3">
            <li><a href="#" data-toggle="sidebar" className="nav-link nav-link-lg
									collapse-btn"><i className="bi bi-columns-gap" style={{ color: 'black' }}></i></a></li>
            <li><a href="#" className="nav-link nav-link-lg fullscreen-btn">
            <i className="bi bi-fullscreen" style={{ color: 'black' }}></i>
              </a></li>
            <li>
        ...
        <ul className="navbar-nav navbar-right">
          <li className="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
              className="nav-link nav-link-lg message-toggle"><i className="bi bi-envelope" style={{ color: 'black' }}></i>
          ...
          <li className="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
              className="nav-link notification-toggle nav-link-lg"><i className="bi bi-envelope" style={{ color: 'black' }}></i>
            </a>
            <div className="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              <div className="dropdown-header">
                Notifications
